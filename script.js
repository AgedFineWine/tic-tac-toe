...
function Gameboard() {
    ...
    this.changeCell = function(player, id) {
    ...
    this.checkWin = function(playerObj) {
    ...
    this.checkDraw = function(playerObj) {
...
function Game() {
    ...
    this.handleBtnClick = function(id, btn) {
